   DAEA  0646  dect R6                     (14)
   DAEC  C584  mov  R4,*R6                 (30)
   DAEE  0204  li   R4,>2000               (20)
   DAF2  0646  dect R6                     (14)
   DAF4  C584  mov  R4,*R6                 (30)
   DAF6  0204  li   R4,>1ffe               (20)
   DAFA  0646  dect R6                     (14)
   DAFC  C584  mov  R4,*R6                 (30)
   DAFE  0204  li   R4,>0101               (20)
   DB02  06A0  bl   @>dac0                 (32)  * CALL FILLW 
  *************** sieve program *****************
   DB06  04C0  clr  R0                     (14)
   DB08  04C3  clr  R3                     (14)
...
>  DB16  0646  dect R6                    
   ...
   DB1E  0647  dect R7             * FOR loop starts        
   DB20  C5C4  mov  R4,*R7                
   DB22  C136  mov  *R6+,R4               
   DB24  90F5  cb   *R5+,R3               
   DB26  130E  jeq  >db44                 
